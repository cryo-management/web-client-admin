<template>
  <section>
    <div class="column">
      <nav class="breadcrumb" aria-label="breadcrumbs">
        <ul>
          ...
          <li class="is-active">
            <a href="#" aria-current="page">Language List</a>
          </li>
        </ul>
      </nav>
    </div>
    <div class="column card">
          ...
          <b-table-column field="actions" label="Actions" width="90" centered>
            <div class="buttons">
              <router-link
                ...
                :to="`/admin/languages/${props.row.id}`"
              >
      ...
      <router-link class="button is-success" to="/admin/languages/create">
        New Language
      </router-link>
...
export default {
  ...
  watch: {
    dataStore() {
      this.data = this.$store.getters['language/languages']
    },
  },
  mounted() {
    this.getLanguages()
